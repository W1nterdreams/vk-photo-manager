...
import { vkInit, loadUser, getAccessToken } from "./vk-api.js?v=20260924-searcharrows36";
import {
    GroupAccessDeniedError,
    precheckLaunchGroupAccess,
    initGroupContext
} from "./group-context.js?v=20260924-searcharrows36";
import { initAlbums, loadAlbums } from "./albums.js?v=20260924-searcharrows36";
import { openAlbum } from "./photos.js?v=20260924-searcharrows36";
import { initMainMenu } from "./main-menu.js?v=20260924-searcharrows36";
import { initAlbumCreate } from "./album-create.js?v=20260924-searcharrows36";
import { initAlbumEdit } from "./album-edit.js?v=20260924-searcharrows36";
import { initAlbumDelete } from "./album-delete.js?v=20260924-searcharrows36";
import { initAlbumReorder } from "./album-reorder.js?v=20260924-searcharrows36";
import { initComments } from "./comments.js?v=20260924-searcharrows36";
import { initAlbumComments } from "./album-comments.js?v=20260924-searcharrows36";
import { initPhotoViewer, openPhotoViewer } from "./photo-viewer.js?v=20260924-searcharrows36";
import { initPhotoUpload } from "./photo-upload.js?v=20260924-searcharrows36";
import { initPhotoMenu } from "./photo-menu.js?v=20260924-searcharrows36";
import { initPhotoTransfer } from "./photo-transfer.js?v=20260924-searcharrows36";
import { initPhotoReorder } from "./photo-reorder.js?v=20260924-searcharrows36";
import { initNavigation, showAlbumsScreen } from "./navigation.js?v=20260924-searcharrows36";
import { escapeHtml, getErrorMessage, logError } from "./helpers.js?v=20260924-searcharrows36";
import { cleanupLegacyCache } from "./cache.js?v=20260924-searcharrows36";
import { initGlobalPhotoSearch } from "./global-photo-search.js?v=20260924-searcharrows36";
import { initPhotoIndexSync } from "./photo-index-sync.js?v=20260924-searcharrows36";
