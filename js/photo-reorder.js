...
import { getPhotoPreviewUrl, getErrorMessage } from "./helpers.js?v=20260920-albumtools14";
...
async function redrawCurrentAlbum(albumId) {
    ...
    try {
        const { setPhotoDateSort } = await import("./photos.js?v=20260920-albumtools14");
        setPhotoDateSort("vk");
    } catch (error) {
