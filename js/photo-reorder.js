...
import { getPhotoPreviewUrl, getErrorMessage } from "./helpers.js?v=20260920-albumtools12";
...
async function chooseTarget(targetPhoto) {
    ...
    try {
        ...
        if (
            ...
            try {
                const { setPhotoDateSort } = await import("./photos.js?v=20260920-albumtools12");
