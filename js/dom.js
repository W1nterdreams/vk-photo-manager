...
export const dom = {
 ...
 albumSortControls:id("albumSortControls"), sortNewestButton:id("sortNewestButton"), sortOldestButton:id("sortOldestButton"), refreshAlbums:id("refreshAlbums"), refreshComments:id("refreshComments"), backButton:id("backButton"), albumSearch:id("albumSearch"), clearSearch:id("clearSearch"),
 menuButton:id("menuButton"), mainMenu:id("mainMenu"), menuContainer:document.querySelector(".menu-container"), createAlbumMenuButton:id("createAlbumMenuButton"), commentsMenuButton:id("commentsMenuButton"), uploadPhotoMenuButton:id("uploadPhotoMenuButton"), copyAlbumLinkMenuButton:id("copyAlbumLinkMenuButton"), editAlbumMenuButton:id("editAlbumMenuButton"), downloadPhotoMenuButton:id("downloadPhotoMenuButton"), editPhotoDescriptionMenuButton:id("editPhotoDescriptionMenuButton"), copyPhotoMenuButton:id("copyPhotoMenuButton"), movePhotoMenuButton:id("movePhotoMenuButton"),
