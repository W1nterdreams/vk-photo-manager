...
import {
    escapeHtml,
    getPhotoPreviewUrl
} from "./helpers.js?v=20260920-uploadsafe01";
import {
    showCommentsScreen,
    pushCommentsHistory
} from "./navigation.js?v=20260920-uploadsafe01";
import { getOwnerId } from "./group-context.js?v=20260920-uploadsafe01";
import { cacheGet, cacheSet, invalidateCommentCaches } from "./cache.js?v=20260920-uploadsafe01";
import { CACHE_TTL } from "./config.js?v=20260920-uploadsafe01";
import { createPhotoComment, getPhotoCommentErrorText } from "./photo-comment-api.js?v=20260920-uploadsafe01";
import { openVkProfile, openVkTarget, openVkPhoto } from "./vk-links.js?v=20260920-uploadsafe01";
import { openPhotoViewer } from "./photo-viewer.js?v=20260920-uploadsafe01";
