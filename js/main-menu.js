...
import { openAlbumReorderMode } from "./photo-reorder.js?v=20260922-adminfix29";
...
export function initMainMenu() {
    ...
    dom.globalPhotoSearchMenuButton?.addEventListener("click", async () => {
        await closeMenu();
        const { openGlobalPhotoSearch } = await import("./global-photo-search.js?v=20260922-adminfix29");
