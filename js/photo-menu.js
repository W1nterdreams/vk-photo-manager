...
import { getBestPhotoUrl, getErrorMessage } from "./helpers.js?v=20260922-search30";
import { getOwnerId } from "./group-context.js?v=20260922-search30";
import {
    invalidateAlbumPhotosCache,
    invalidateAlbumCaches,
    invalidatePhotoActivityCaches
} from "./cache.js?v=20260922-search30";
import { closeMenu } from "./main-menu.js?v=20260922-search30";
import { openPhotoTransfer } from "./photo-transfer.js?v=20260922-search30";
import { openPhotoReorder } from "./photo-reorder.js?v=20260922-search30";
import { openVkPhoto } from "./vk-links.js?v=20260922-search30";
import { openSwipeOverlay, closeSwipeOverlay } from "./overlay-history.js?v=20260922-search30";
import { markPhotoIndexAlbumDirty, clearPhotoIndexAlbumDirty } from "./photo-index-db.js?v=20260922-search30";
import { applyLocalPhotoUpdate, applyLocalPhotoDelete } from "./photo-index-sync.js?v=20260922-search30";
...
async function refreshAfterNativeDelete(detail) {
    ...
    if (album) {
        try {
            const { loadPhotos } = await import("./photos.js?v=20260922-search30");
