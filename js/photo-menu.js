...
import { getBestPhotoUrl, getErrorMessage } from "./helpers.js?v=20260921-photoindex25";
...
} from "./cache.js?v=20260921-photoindex25";
import { closeMenu } from "./main-menu.js?v=20260921-photoindex25";
...
import { openVkPhoto } from "./vk-links.js?v=20260921-photoindex25";
import { openSwipeOverlay, closeSwipeOverlay } from "./overlay-history.js?v=20260921-photoindex25";
import { markPhotoIndexAlbumDirty, clearPhotoIndexAlbumDirty } from "./photo-index-db.js?v=20260921-photoindex25";
import { applyLocalPhotoUpdate, applyLocalPhotoDelete } from "./photo-index-sync.js?v=20260921-photoindex25";
...
async function refreshAfterNativeDelete(detail) {
    ...
    if (album) {
        try {
            const { loadPhotos } = await import("./photos.js?v=20260921-photoindex25");
