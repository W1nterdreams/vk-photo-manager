...
import { getBestPhotoUrl, getErrorMessage } from "./helpers.js?v=20260924-centermenu37";
...
import { closeMenu } from "./main-menu.js?v=20260924-centermenu37";
import { openPhotoTransfer } from "./photo-transfer.js?v=20260924-centermenu37";
import { openPhotoReorder } from "./photo-reorder.js?v=20260924-centermenu37";
import { openVkPhoto } from "./vk-links.js?v=20260924-centermenu37";
import { openSwipeOverlay, closeSwipeOverlay } from "./overlay-history.js?v=20260924-centermenu37";
import { markPhotoIndexAlbumDirty, clearPhotoIndexAlbumDirty } from "./photo-index-db.js?v=20260924-centermenu37";
import { applyLocalPhotoUpdate, applyLocalPhotoDelete } from "./photo-index-sync.js?v=20260924-centermenu37";
